$(async function () {
    ...
    const maintenanceWindowId = $("#maintenanceWindowModal").data("maintenance-window-id");
    const localMaintenanceWindowId = localStorage.getItem("maintenance-window-id");

    if (localMaintenanceWindowId && localMaintenanceWindowId === maintenanceWindowId)
        return;
